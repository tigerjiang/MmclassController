...
public class ControllerActivity extends Activity implements OnClickListener,
    ...
    private RadioGroup mBroadCastRadioGroup;
    private RadioGroup mMicRadioGroup;
    ...
    private Switch mMicSwitch, mSpeakerSwitch;
...
//				mTimeHandler.sendEmptyMessageDelayed(1, 1000);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBroadCastRadioGroup = (RadioGroup) findViewById(R.id.broadcast_group);
        mBroadCastRadioGroup.setOnCheckedChangeListener(this);
        mMicSwitch = (Switch) findViewById(R.id.mic_sw);
        mSpeakerSwitch = (Switch) findViewById(R.id.speaker_sw);
        mMicSwitch.setOnCheckedChangeListener(mSwitchListener);
        mSpeakerSwitch.setOnCheckedChangeListener(mSwitchListener);
        mMicRadioGroup = (RadioGroup) findViewById(R.id.mic_group);
        mMicRadioGroup.setOnCheckedChangeListener(this);
  ...
  private CompoundButton.OnCheckedChangeListener mSwitchListener = new CompoundButton.OnCheckedChangeListener() {
      ...
      public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
          if (compoundButton.getId() == R.id.mic_sw) {
              if (isChecked) {
          ...
          } else if (compoundButton.getId() == R.id.speaker_sw) {
             if(isChecked) {
                 if (CommandManager.getSpeakerStatus() == 1 || !mIsSpeakerOn) {
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        switch (checkedId) {
            ...
            case R.id.check_remote:
                ...
                break;
            case R.id.front_mic_rb:
                CommandManager.sendMicSwitchMessage("front");
                break;
            case R.id.bg_mic_rb:
                CommandManager.sendMicSwitchMessage("back");
                break;
            default:
                break;
        }
